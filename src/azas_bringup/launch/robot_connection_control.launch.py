...
def generate_launch_description():
    ...
    yolo_to_floor_place_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "hand_eye_matrix_path": LaunchConfiguration("hand_eye_matrix_path"),
            "hand_eye_parent_frame": LaunchConfiguration("hand_eye_parent_frame"),
            "hand_eye_matrix_child_frame": LaunchConfiguration("hand_eye_matrix_child_frame"),
            "hand_eye_published_child_frame": LaunchConfiguration("hand_eye_published_child_frame"),
            "hand_eye_translation_scale": LaunchConfiguration("hand_eye_translation_scale"),
            "hand_eye_compose_with_existing_tf": LaunchConfiguration("hand_eye_compose_with_existing_tf"),
            "hand_eye_compose_timeout_sec": LaunchConfiguration("hand_eye_compose_timeout_sec"),
        }.items(),
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("hand_eye_matrix_path", default_value=""),
