...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("side_trajectory_execution_duration_scaling", default_value="3.0"),
        DeclareLaunchArgument("side_trajectory_execution_goal_margin_sec", default_value="3.0"),
        ...
        DeclareLaunchArgument("resume_state_file", default_value="/home/ssu/Azas/outputs/auto_cup_flow_resume.json"),
        DeclareLaunchArgument("resume_events_file", default_value="/home/ssu/Azas/outputs/auto_cup_flow_events.jsonl"),
        DeclareLaunchArgument(
            "dispenser_resume_state_file",
            default_value="/home/ssu/Azas/outputs/measured_dispenser_recipe_resume.json",
        ),
        Node(
            ...
            parameters=[{
                ...
                "motion_service_prefix": LaunchConfiguration("motion_service_prefix"),
                ...
                "side_trajectory_execution_duration_scaling": ParameterValue(
                    LaunchConfiguration("side_trajectory_execution_duration_scaling"),
                    value_type=float,
                ),
                "side_trajectory_execution_goal_margin_sec": ParameterValue(
                    LaunchConfiguration("side_trajectory_execution_goal_margin_sec"),
                    value_type=float,
                ),
                ...
                "dispenser_3_cup_pre_extra_x_offset_m": ParameterValue(LaunchConfiguration("dispenser_3_cup_pre_extra_x_offset_m"), value_type=float),
                ...
                "resume_state_file": LaunchConfiguration("resume_state_file"),
                "resume_events_file": LaunchConfiguration("resume_events_file"),
                "dispenser_resume_state_file": LaunchConfiguration("dispenser_resume_state_file"),
            }],
        ),
    ])
