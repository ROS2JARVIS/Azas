...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("color_scan_before_recipe", default_value="true"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "color_scan_before_recipe": ParameterValue(LaunchConfiguration("color_scan_before_recipe"), value_type=bool),
