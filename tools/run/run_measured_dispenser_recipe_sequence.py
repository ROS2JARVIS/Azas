...
def main() -> int:
    ...
    if final_dispenser_id == "1":
        args.cup_holder_place_final_x_offset_m += (
            args.cup_holder_place_final_dispenser_1_x_extra_offset_m
        )
        print(
            "[Azas] dispenser 1 final cup-holder X extra offset applied: "
            f"{args.cup_holder_place_final_dispenser_1_x_extra_offset_m:.3f} m, "
    ...
    if final_dispenser_id == "2":
        ...
        print(
            "[Azas] dispenser 2 final cup-holder XY extra offset applied: "
            f"x={args.cup_holder_place_final_dispenser_2_x_extra_offset_m:.3f} m, "
            f"y={args.cup_holder_place_final_dispenser_2_y_extra_offset_m:.3f} m, "
            f"effective_place_final_x_offset_m={args.cup_holder_place_final_x_offset_m:.3f}, "
            f"effective_place_final_y_offset_m={args.cup_holder_place_final_y_offset_m:.3f}"
        )
    if final_dispenser_id == "3":
        args.cup_holder_place_final_x_offset_m += (
        ...
        print(
            "[Azas] dispenser 3 final cup-holder XY extra offset applied: "
            f"x={args.cup_holder_place_final_dispenser_3_x_extra_offset_m:.3f} m, "
            f"y={args.cup_holder_place_final_dispenser_3_y_extra_offset_m:.3f} m, "
            f"effective_place_final_x_offset_m={args.cup_holder_place_final_x_offset_m:.3f}, "
            f"effective_place_final_y_offset_m={args.cup_holder_place_final_y_offset_m:.3f}"
        )
    if final_dispenser_id == "4":
        ...
        print(
            "[Azas] dispenser 4 final cup-holder XY extra offset applied: "
            f"x={args.cup_holder_place_final_dispenser_4_x_extra_offset_m:.3f} m, "
            f"y={args.cup_holder_place_final_dispenser_4_y_extra_offset_m:.3f} m, "
            f"effective_place_final_x_offset_m={args.cup_holder_place_final_x_offset_m:.3f}, "
            f"effective_place_final_y_offset_m={args.cup_holder_place_final_y_offset_m:.3f}"
        )
    print(
