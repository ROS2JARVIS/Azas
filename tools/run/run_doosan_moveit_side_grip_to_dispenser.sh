...
export ENABLE_SAFE_LIFT_TRANSFER="${ENABLE_SAFE_LIFT_TRANSFER:-true}"
export SAFE_LIFT_MIN_Z="${SAFE_LIFT_MIN_Z:-0.40}"
export SAFE_LIFT_DELTA_Z="${SAFE_LIFT_DELTA_Z:-0.15}"
export SAFE_LIFT_MAX_Z="${SAFE_LIFT_MAX_Z:-0.55}"
export DISPENSER_ABOVE_Z="${DISPENSER_ABOVE_Z:-0.40}"
...
ros2 run azas_motion doosan_moveit_grasped_tumbler_to_dispenser_node \
  ...
  -p enable_safe_lift_transfer:="${ENABLE_SAFE_LIFT_TRANSFER}" \
  -p safe_lift_min_z:="${SAFE_LIFT_MIN_Z}" \
  -p safe_lift_delta_z:="${SAFE_LIFT_DELTA_Z}" \
  -p safe_lift_max_z:="${SAFE_LIFT_MAX_Z}" \
  -p dispenser_above_z:="${DISPENSER_ABOVE_Z}" \
