...
def main() -> int:
    ...
    parser.add_argument("--cup-holder-place-final-dispenser-4-y-extra-offset-m", default="0.010")
    ...
    sequence_extra_args = [
        ...
        "--cup-holder-place-final-dispenser-1-x-extra-offset-m", str(args.cup_holder_place_final_dispenser_1_x_extra_offset_m),
        "--cup-holder-place-final-dispenser-1-y-extra-offset-m", str(args.cup_holder_place_final_dispenser_1_y_extra_offset_m),
        "--cup-holder-place-final-dispenser-2-x-extra-offset-m", str(args.cup_holder_place_final_dispenser_2_x_extra_offset_m),
        "--cup-holder-place-final-dispenser-2-y-extra-offset-m", str(args.cup_holder_place_final_dispenser_2_y_extra_offset_m),
        "--cup-holder-place-final-dispenser-3-x-extra-offset-m", str(args.cup_holder_place_final_dispenser_3_x_extra_offset_m),
        "--cup-holder-place-final-dispenser-3-y-extra-offset-m", str(args.cup_holder_place_final_dispenser_3_y_extra_offset_m),
